...
sed "s/_PREFIX_/\/${SPREFIX}/g" ${BUILD_DIR}/modules/ActCDTMacrosPackage.cmake &> ${CDT_PREFIX}/lib/cmake/${PROJECT}/ActCDTMacros.cmake
sed "s/_PREFIX_/\/${SPREFIX}/g" ${BUILD_DIR}/modules/ActWasmToolchainPackage.cmake &> ${CDT_PREFIX}/lib/cmake/${PROJECT}/ActWasmToolchain.cmake
...
ln -sf ../../../${SUBPREFIX}/lib/cmake/${PROJECT}/ActWasmToolchain.cmake ActWasmToolchain.cmake
ln -sf ../../../${SUBPREFIX}/lib/cmake/${PROJECT}/ActCDTMacros.cmake ActCDTMacros.cmake
popd &> /dev/null
